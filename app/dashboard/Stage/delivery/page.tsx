...
import DeliveryProjectListingPage from '@/features/Stages/DELIVERY/Project/listing';
...
<Heading 
  ...
  description="Manage Finished projects" 
/>       

               <PermissionGuard requiredPermission={PERMISSIONS.STAGE.VIEW_DELIVERY_PROJECTS.name}>

  <Link
              href='/dashboard/Stage/delivery/finished'
              className={cn(buttonVariants(), 'text-xs md:text-sm')}
            >
              Delivery Finished Projects
