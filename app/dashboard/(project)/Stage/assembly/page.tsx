...
import AssemblyProjectListingPage from '@/features/Stages/ASSEMBLY/Project/listing';
...
/>   
               <PermissionGuard requiredPermission={PERMISSIONS.STAGE.VIEW_ASSEMBLY_PROJECTS.name}>

  <Link
              href='/dashboard/Stage/assembly/finished'
