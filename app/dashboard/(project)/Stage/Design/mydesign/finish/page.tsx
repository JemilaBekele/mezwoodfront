...
import FinMyDesignProjectListingPage from '@/features/Stages/design/Project/finishmydesign';
...
<Heading 
  title="Finished Design stage" 
  description="Manage completed Design stage" 
/>         
        </div>
        <Separator />
        <UserTableAction />
