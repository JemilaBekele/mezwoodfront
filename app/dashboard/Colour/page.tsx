...
import ColourModal from '@/features/Inventory/Colour/view-page';
import ColoursListingPage from '@/features/Inventory/Colour/listing';
    ...
    <PageContainer scrollable={false}>
      <div className='flex flex-1 flex-col space-y-4'>
        <div className='flex items-start justify-between'>
          <Heading
            title='Colours'
            description='Manage Colours information and records.'
          />
