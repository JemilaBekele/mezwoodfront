...
// Helper to get the EDGE_BANDING Works stage
function getMetalWorksStage(project: IProject): IProjectStage | undefined {
  return project.stages?.find(
    (stage: IProjectStage) => stage.stage === ProjectStatus.EDGE_BANDING
  );
}
...
export const ProjectCellAction: React.FC<ProjectCellActionProps> = ({
  ...
  const handleAddWorkLog = async () => {
    if (!stage) {
      toast.error('No EDGE_BANDING Works stage found for this project');
      return;
    }
    ...
    <>
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/Stage/edgebanding/view?id=${data.id}`)
            }
          >
      ...
      <AlertDialog open={showCompleteDialog} onOpenChange={setShowCompleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to complete all remaining work units for this project&apos;s EDGE_BANDING Works stage?
