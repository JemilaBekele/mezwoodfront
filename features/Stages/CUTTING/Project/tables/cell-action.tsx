...
export const ProjectCellAction: React.FC<ProjectCellActionProps> = ({
  ...
  const handleAddWorkLog = async () => {
    if (!stage) {
      toast.error('No cutting Works stage found for this project');
      return;
    }
    ...
    <>
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/Stage/cutting/view?id=${data.id}`)
            }
          >
      ...
      <AlertDialog open={showCompleteDialog} onOpenChange={setShowCompleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to complete all remaining work units for this project&apos;s cutting Works stage?
