...
// Helper to get the FINISHING Works stage
function getMetalWorksStage(project: IProject): IProjectStage | undefined {
  return project.stages?.find(
    (stage: IProjectStage) => stage.stage === ProjectStatus.FINISHING
  );
}
...
export const ProjectCellAction: React.FC<ProjectCellActionProps> = ({
  ...
  const handleAddWorkLog = async () => {
    if (!stage) {
      toast.error('No FINISHING Works stage found for this project');
      return;
    }
    ...
    <>
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/Stage/finishing/view?id=${data.id}`)
            }
          >
      ...
      <AlertDialog open={showCompleteDialog} onOpenChange={setShowCompleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to complete all remaining work units for this project&apos;s FINISHING Works stage?
