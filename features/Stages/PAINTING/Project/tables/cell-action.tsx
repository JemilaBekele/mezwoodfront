...
export const ProjectCellAction: React.FC<ProjectCellActionProps> = ({
  ...
  const handleAddWorkLog = async () => {
    if (!stage) {
      toast.error('No PAINTING Works stage found for this project');
      return;
    }
      ...
      <AlertDialog open={showCompleteDialog} onOpenChange={setShowCompleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to complete all remaining work units for this project&apos;s PAINTING Works stage?
