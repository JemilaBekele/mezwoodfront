...
import { finishprojectColumns } from "./tables/finished";
import { IProject } from "@/models/Projects";

type ProjectListingPageProps = object;

export default function FinMyDesignProjectListingPage(
  ...
  useEffect(() => {
    ...
    const loadProjects = async () => {
      try {
        ...
        const response = await mygetdesignProjects({
          status: "finished",
        });
