...
export default function FinishedMetalworkProjectListingPage(
  ...
  useEffect(() => {
    ...
    const loadProjects = async () => {
      try {
        ...
        const response = await getMetalWorkProjects({
          status: "finished",
        });
        ...
        console.error("Error loading metal work projects:", err);
