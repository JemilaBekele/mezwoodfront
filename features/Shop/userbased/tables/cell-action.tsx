...
import { IconEdit, IconDotsVertical, IconTrash, IconWallet, IconX, IconFile } from '@tabler/icons-react';
        ...
        <DropdownMenuContent align='end'>
          ...
          {(data.saleStatus === 'APPROVED' ||
            ...
            <PermissionGuard requiredPermission={PERMISSIONS.SELL.UPDATE.name}>
              <DropdownMenuItem
                onClick={() => router.push(`/dashboard/UserBasedSell/${data.id}`)}
              >
          ...
          <DropdownMenuItem
            onClick={() => router.push(`/dashboard/UserBasedSell/view?id=${data.id}`)}
          >
