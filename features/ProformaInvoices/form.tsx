...
import { IAttachment, IProformaInvoice, IProformaInvoiceItem, IProformaItemMaterial } from '@/models/ProformaInvoice';
import { Textarea } from '@/components/ui/textarea';
import Select from 'react-select';
import { ArrowLeft, Plus, Trash2, Upload, Download, Image as ImageIcon, Package, Eye, RefreshCw, X, Check, AlertCircle, CheckSquare } from 'lucide-react';
...
// Replace your attachment handlers with these
  ...
  <CardContent className="space-y-3 px-4 pb-4">
    ...
    {existingAttachments.length > 0 && (
      <div className="space-y-2">
        <p className="text-xs font-semibold text-muted-foreground">Existing Attachments</p>
    ...
    {newAttachments.length > 0 && (
      <div className="space-y-2">
        <p className="text-xs font-semibold text-muted-foreground">New Attachments</p>
        {newAttachments.map((file, index) => (
          <div
            key={`new-${index}`}
            className="flex items-center justify-between rounded-lg border border-blue-200 bg-blue-50/50 dark:border-blue-800 dark:bg-blue-950/20 px-4 py-2.5"
          >
